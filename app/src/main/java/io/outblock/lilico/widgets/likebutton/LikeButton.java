...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    public void setUnLikeDrawableTint(@ColorInt int color) {
        if (unLikeDrawable == null) {
            return;
        }
        unLikeDrawable.setTint(color);
    }

    public void setLikeDrawableTint(@ColorInt int color) {
        if (likeDrawable == null) {
            return;
        }
        likeDrawable.setTint(color);
    }
