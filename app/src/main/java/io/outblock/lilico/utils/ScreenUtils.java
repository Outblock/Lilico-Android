...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return Env.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) Env.getApp().getSystemService(Context.KEYGUARD_SERVICE);
        //noinspection ConstantConditions
    ...
    public static boolean isTablet() {
        return (Env.getApp().getResources().getConfiguration().screenLayout
