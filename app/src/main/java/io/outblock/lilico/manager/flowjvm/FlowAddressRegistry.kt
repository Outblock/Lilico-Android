...
internal class FlowAddressRegistry {
    ...
    private fun register(net: FlowChainId) {
        ...
        registry.register("0xFlowToken", FlowAddress(if (isDev()) "0x1654653399040a61" else "0x7e60df042a9c0868"), net)
        registry.register("0xFungibleToken", FlowAddress(if (isDev()) "0xf233dcee88fe0abe" else "0x9a0766d93b6608b7"), net)
